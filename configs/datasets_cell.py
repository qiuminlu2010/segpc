albu_train_transforms = [
    ...
    dict(type='RandomRotate90',p=1.0),#修改
]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file='./datasets/trainval/train_cell_t298.json',
        img_prefix='./datasets/trainval/x',
        seg_prefix = './datasets/trainval/cell_seg',   
    ...
    val=dict(
        ...
        ann_file='./datasets/trainval/val_cell_t200.json',
        img_prefix='./datasets/trainval/x',
    ),
    test=dict(
        type=dataset_type,
